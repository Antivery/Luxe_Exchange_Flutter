...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFFF007A);
  Color secondaryColor = const Color(0xFFE3B3D1);
  Color tertiaryColor = const Color(0xFFFF007A);
  Color alternate = const Color(0xFF8A8A8A);
  Color primaryBackground = const Color(0xFFFFFFFF);
  Color secondaryBackground = const Color(0xFFE3B3D1);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  Color secondaryBackground = const Color(0xFF8A8A8A);
